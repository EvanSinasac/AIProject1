...
// This enemy class is based on the SteeringBehaviour class we made in class
// In that each enemy type will inherit this class and depending on the required behaviours
// for that enemy, it will change how CalculateSteeringForce will work
...
public class Enemy : MonoBehaviour
{
    ...
    {
        if (!collision.gameObject.CompareTag("Paintball")) return;
        EnemySpawnController.ReduceEnemyCount();
        Score.AddPoint();
        Destroy(gameObject);
    }
}
